        ...
        <div className="text-lg mt-4 w-full">
          ...
          <div className="flex flex-col items-center">
            {combinations.map((combo, comboIndex) => (
              <div key={comboIndex} className="flex flex-col md:flex-row items-center justify-between w-full mb-4 p-2 rounded-lg ">
                <div className="flex flex-wrap justify-center md:justify-start w-full md:w-auto mb-2 md:mb-0">
                  {combo.map((number, index) => (
                    <div
                      key={number}
                      className="number-circle m-1"
                      style={{
                ...
                <button
                  className="bg-red-600 hover:bg-red-700 text-white p-1 rounded-full focus:outline-none transition-colors duration-300 mt-2 md:mt-0 md:ml-2"
