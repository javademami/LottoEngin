...
const AboutLottery = () => {
  return (
    <div className="h-full flex flex-col">
      <div className="bg-primary rounded-lg shadow-lg overflow-hidden flex-grow">
        <img 
          src="https://om.svenskaspel.se/wp-content/uploads/2023/09/lotto-press-2020-4184-1030x658.jpg" 
          alt="Swedish Lotto" 
          className="w-full h-64 object-cover"
        />
        <div className="p-6 bg-opacity-90 bg-primary flex flex-col justify-between h-full">
          <div className="space-y-4">
            ...
            <h3 className="text-xl font-semibold mt-6 mb-2 text-center text-white">How to win:</h3>
